...
\begin{figure}[tbp]
	...
	\caption{A segment with  intersecting segments and the different induced stub lengths.} % The shaded areas are the stubs, $ p(u) $ is the parent of $ u $. The stubs in the boxed area contribute to $ \solshort(u) $.}
	\label{fig:tree}
\end{figure}
