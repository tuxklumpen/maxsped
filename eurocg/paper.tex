...
\title{Maximal Symmetric Partial Edge Drawings With Degree $ > 2$}
...
\section{Trees}
\fabian{Algorithm running in $O(k^2n)$ where $ k $ is the max degree of the tree.}

\section{Bridge? Cactus Graphs}
\fabian{Algorithm running in $ O(kn^2) $?}
